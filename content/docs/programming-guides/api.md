...
[Proto Best Practices](/docs/programming-guides/dos-donts).
...
See [Custom Options](/docs/programming-guides/proto#options)
...
table in the
[Protocol Buffer Language Guide](/docs/programming-guides/proto#scalar).
...
## Group Related Fields into a New Message. Nest *Only* Tightly-Coupled Messages. {#group-related-fields}
...
If the fields are genuinely related, you'll often want to pass them around
together inside a server. That's easier if they're defined together in a
message. Think:
...
`FieldMaskUtil`
([Java](/docs/reference/java/api-docs/com/google/protobuf/util/FieldMaskUtil.html)/[C++](/docs/reference/cpp/api-docs/google.protobuf.util.field_mask_util.md))
...
of time, use
[`google.protobuf.Any`](/docs/reference/protobuf/textformat-spec#any).
