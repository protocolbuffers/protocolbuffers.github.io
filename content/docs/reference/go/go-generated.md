...
[`package` specifier](/docs/programming-guides/proto3#packages) in the `.proto`
...
([as it should](/docs/programming-guides/style)). The case-conversion works as
follows:
...
[scalar value types table](/docs/programming-guides/proto#scalar).
...
For other scalar field types (including `bool`, `bytes`, and `string`), `int32`
is replaced with the corresponding Go type according to the
[scalar value types table](/docs/programming-guides/proto3#scalar). Unset values
...
[scalar value types table](/docs/programming-guides/proto3#scalar).
