...
-   `static const Descriptor* descriptor()`: Returns the type's descriptor. This
    ...
    [reflection](/docs/reference/cpp/api-docs/google.protobuf.message#Reflection)
...
[unknown field](/docs/reference/cpp/api-docs/google.protobuf.unknown_field_set).
...
[Arena Allocation Guide](/docs/reference/cpp/arenas).
