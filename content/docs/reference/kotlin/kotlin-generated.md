...
for [Java](/docs/reference/java/java-generated). Any differences
...
read the [proto2 language guide](/docs/programming-guides/proto) and/or
...
[Java generated code reference](/docs/reference/java/java-generated#package).
...
-   `val oneofNameCase: OneofNameCase`: gets which, if any, of the `oneof_name`
    ...
    [Java code reference](/docs/reference/java/java-generated#oneof)
    for the return type
